        ...
        {articles.map((article) => {
          ...
          return (
            <li className="mb-2" key={article.id}>
              <Link onClick={closeSearch} to={articleUrl} className="items-center flex">
                {article.image?.url && (
                  <Image
        ...
        {collections.map((collection) => {
          ...
          return (
            <li className="mb-2" key={collection.id}>
              <Link onClick={closeSearch} to={collectionUrl} className="items-center flex">
        ...
        {products.map((product) => {
          ...
          return (
            <li className="mb-2" key={product.id}>
              <Link to={productUrl} onClick={closeSearch} className="items-center flex">
                {image && (
                  <Image
                    alt={image.altText ?? ''}
                    src={image.url}
